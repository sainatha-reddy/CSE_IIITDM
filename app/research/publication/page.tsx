    ...
    return [
      {
        ...
        publications: [
          ...
          },
          {
            ...
            year: 2020,
            type: "book",
            doi: "10.1016/B978-0-12-123456-0.00001-0",
            citations: 25,
            abstract: "This comprehensive textbook covers the foundations and applications of computer vision and image processing techniques.",
      ...
      },
      {
        ...
        publications: [
          ...
          },
          {
            ...
            citations: 3,
            abstract: "This book chapter explores recent advances in Network-on-Chip architectures for modern computing systems.",
            keywords: ["Computer Architecture", "NoC", "System Design"]
          }
        ],
        publicationCount: 3
      }
